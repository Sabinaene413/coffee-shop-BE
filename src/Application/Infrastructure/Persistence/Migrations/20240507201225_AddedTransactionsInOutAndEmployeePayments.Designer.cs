...
namespace MyCoffeeShop.Application.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240507201225_AddedTransactionsInOutAndEmployeePayments")]
    partial class AddedTransactionsInOutAndEmployeePayments
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyCoffeeShop.Application.Users.UserCredential", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "coffee_shop@gmail.com",
                            PasswordHash = "D3/v9BGjPjSluefqYfh3DHl8wZ2CYHGuQkbNuB5f9cI=",
                            PasswordSalt = "SKloB1qLi+ecYyZLhaoAkA=="
                        });
                });
